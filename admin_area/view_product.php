		...
		<table class="table table-bordered table-hover table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><img src="product_images/<?php echo $product_img1; ?>" width="100" height="70"></td>
					<td><?php echo $product_price; ?></td>
					<td><?php echo $product_keywords; ?></td>
					<td><?php echo $date; ?></td>
					<td>
						<a href="index.php?delete_product=<?php echo $pro_id ?>"><i class="fa fa-trash-o"></i>Delete</a>
					</td>
					<td>
